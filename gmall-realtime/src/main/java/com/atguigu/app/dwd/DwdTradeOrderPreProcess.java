...
public class DwdTradeOrderPreProcess {
    public static void main(String[] args) {
        ...
        //TODO 2.创建topic_db表
        tableEnv.executeSql(MyKafkaUtil.getTopicDb("OrderPreProcess"));
        //TODO 3.过滤出订单明细数据 订单明细没有update
        ...
        //TODO 10.将数据写出
        tableEnv.executeSql("insert into table dwd_order_pre select * from result_table");
    }
}
